...
.center[
```{r map_iptds, eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE}
library(tidyverse)
library(leaflet)
...
.dfrm[Department of Fisheries Resources Management]
 ...
 [https://nezperce.org/government/fisheries-resources-management](https://nezperce.org/government/fisheries-resources-management/)
